...
class BaiduLocationIOSOption{
  ...
  BaiduLocationIOSOption({this.locationTimeout,
    this.reGeocodeTimeout, this.activityType,
    // ignore: non_constant_identifier_names
    this.BMKLocationCoordinateType, this.desiredAccuracy,
    this.isNeedNewVersionRgc, this.pausesLocationUpdatesAutomatically,
    this.allowsBackgroundLocationUpdates, this.distanceFilter
  });
  ...
  factory BaiduLocationIOSOption.fromMap(dynamic value){
    return new BaiduLocationIOSOption(
      ...
      pausesLocationUpdatesAutomatically: value['pausesLocationUpdatesAutomatically'],
