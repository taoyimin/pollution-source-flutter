  ...
  /*static EnterDetail fromJson(dynamic json) {
    if (SpUtil.getBool(Constant.spJavaApi, defValue: true)) {
      return EnterDetail(
        ...
        enterTel: json['ent_linkphone'],
        contactPerson: json['envir_linkman'],
        contactPersonTel: json['envir_linkphone'],
        legalPerson: json['legalperson'],
        legalPersonTel: json['legallinkphone'],
        attentionLevelStr: json['attentionLevelstr'],
        districtName: json['city_Name']+json['area_Name'],
        industryTypeStr: json['industryTypeStr'],
        creditCode: json['legalperson_code'],
        orderCompleteCount: '-',
        orderTotalCount: '-',
        longStopReportTotalCount: '-',
