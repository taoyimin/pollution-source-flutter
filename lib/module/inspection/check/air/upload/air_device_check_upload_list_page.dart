...
/// 废气监测设备校验上报列表
class AirDeviceCheckUploadListPage extends StatefulWidget {
  final String monitorId;
  final String itemInspectType;
  final String state;

  AirDeviceCheckUploadListPage({
  ...
  @override
  _AirDeviceCheckUploadListPageState createState() =>
      _AirDeviceCheckUploadListPageState();
}

class _AirDeviceCheckUploadListPageState
    extends State<AirDeviceCheckUploadListPage>
