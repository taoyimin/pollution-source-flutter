...
/// 废水监测设备校准上报列表
class WaterDeviceCorrectUploadListPage extends StatefulWidget {
  final String monitorId;
  final String itemInspectType;
  final String state;

  WaterDeviceCorrectUploadListPage({
  ...
  @override
  _WaterDeviceCorrectUploadListPageState createState() =>
      _WaterDeviceCorrectUploadListPageState();
}

class _WaterDeviceCorrectUploadListPageState
    extends State<WaterDeviceCorrectUploadListPage>
            ...
            child: InkWellButton(
              onTap: () async {
                bool success = await Application.router.navigateTo(context,
                    '${Routes.waterDeviceCorrectUpload}?json=${Uri.encodeComponent(json.encode(list[index].toJson()))}');
                if (success ?? false) {
