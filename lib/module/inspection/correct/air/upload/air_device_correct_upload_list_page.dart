...
/// 废气监测设备校准上报列表界面
class AirDeviceCorrectUploadListPage extends StatefulWidget {
  final String monitorId;
  final String itemInspectType;
  final String state;

  AirDeviceCorrectUploadListPage({
  ...
  @override
  _AirDeviceCorrectUploadListPageState createState() =>
      _AirDeviceCorrectUploadListPageState();
}

class _AirDeviceCorrectUploadListPageState
    extends State<AirDeviceCorrectUploadListPage>
            ...
            child: InkWellButton(
              onTap: () async {
                bool success = await Application.router.navigateTo(context,
                    '${Routes.airDeviceCorrectUpload}?json=${Uri.encodeComponent(json.encode(list[index].toJson()))}');
                if (success ?? false) {
